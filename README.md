...
- Click the character again to open the full settings and adjust Level, Insight, Resonance, and Portray
...
If you are going to record every character in your suitcase, it is recommended to use "Set Defaults" first and set your most common character state as the default—for example: Insight 3, max level, Resonance 10, Portray 0, and Insight Skin.

Search supports all available languages.
...
Because the vast majority of psychubes only have one copy, this tool does not include management for multiple copies.
Since many veteran players already own every psychube, "Set Defaults" can set all psychubes as owned by default; then simply unmark the ones you do not own.

### Teams

Click an empty character slot to select a character, and click a psychube slot to change the psychube. Teams can be named freely, with a limit of 12 characters.

---

## How Share URLs Work

This is the most important feature update in this release.

When you open the site through a share URL, you enter "Preview Mode." If the link is one you saved yourself, you can choose to import it and overwrite your data.

If you are helping someone else with team-building advice, you can:
...
So when you receive someone else's team URL, you can safely open it, look around, and make changes without worrying that your own configuration will be overwritten.

If the shared configuration includes Future Sight content, you will also be notified and can choose whether to import it.

---

## Future Sight

Because each server progresses at a different pace, the site displays the overseas server's current progress by default. Users who need it can enable Future Sight.

---

## Export Images

Image export now supports three formats:
...
That means if you are viewing someone else's shared preview, that preview is what will be exported.
